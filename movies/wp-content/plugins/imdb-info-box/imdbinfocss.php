...
echo '#imdbinfo {clear:both;border:solid 1px #'.$hb.';background:#'.$bb.'}
#imdbinfo th{line-height:1.3em;font-size:1.2em;text-align:center;color:#'.$hf.';background:#'.$hb.';padding:2px}
